...
exports.calculateKFactor = calculateKFactor;
exports.calculateEloChange = calculateEloChange;
exports.getResultFromWinner = getResultFromWinner;
 ...
 */
function calculateKFactor(gamesPlayed, rating) {
 ...
 */
function calculateEloChange(ratingA, ratingB, gamesPlayedA, gamesPlayedB, result) {
    // Validate result
 ...
 */
function getResultFromWinner(modelAId, modelBId, winnerId) {
    if (winnerId === null) {
        return 0.5; // Tie
    }
